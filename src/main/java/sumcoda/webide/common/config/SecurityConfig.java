...
//        허용할 출처 설정
        configuration.setAllowedOrigins(List.of("http://localhost:3000", "http://ec2-3-35-39-158.ap-northeast-2.compute.amazonaws.com:3000", "http://ec2-52-79-123-145.ap-northeast-2.compute.amazonaws.com"));
