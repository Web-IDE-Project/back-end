...
public class WorkspaceResponseDAO {
    ...
    @Builder
    public WorkspaceResponseDAO(Long id, String title, Language language, String description, Status status, String username, String nickname, String awsS3SavedFileURL) {
        this.id = id;
        this.title = title;
