  ...
  <tr>
    ...
    <td>
      <ul>
        <li>백엔드 CI/CD 구축</li>
        <li>ERD 설계 및 구현</li>
        <li>AWS 인프라 구축 및 배포</li>
        <li>로그인 및 유저 관리, 언어별 독립적인 컴파일 환경 구축, 터미널 로직 구현, 파일 시스템 구현</li>
      </ul>
    </td>
    <td>
      <ul>
        <li>폴더 및 디렉토리 생성, 수정, 저장, 삭제 기능</li>
        <li>컨테이너 공유, 상태 수정, 삭제 기능</li>
      </ul>
    </td>
    <td>
      <ul>
    ...
    <td>
      <ul>
        <li>채팅/터미널 기능 웹소켓 연결, 채팅 저장 구현</li>
        <li>음성 채팅 시그널링 서버 구현</li>
      </ul>
    </td>
  </tr>
</table>
